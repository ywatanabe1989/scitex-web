...
#
# Usage:
#     python -m scitex_web.download_images https://example.com
#     python -m scitex_web.download_images https://example.com -o ./downloads
#     python -m scitex_web.download_images https://example.com --min-size 800x600
# """
#
# import os
# import re
...
#   python -m scitex_web.download_images https://example.com -o ./downloads
#   python -m scitex_web.download_images https://example.com --min-size 800x600
#   python -m scitex_web.download_images https://example.com --no-min-size
#         """,
#     )
