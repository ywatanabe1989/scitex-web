...
# (project=scitex-web, owner=ywatanabe1989, repo=scitex-web,
...
TMPDIR="/tmp/publish-scitex_web-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-web dist/* uploaded to PyPI via manual OIDC trusted publishing"
